function [sysr,hsv] = spa(sys,tol,ord,alpha)
%SPA    Singular perturbation approximation without balancing.
%       [SYSR,HSV] = SPA(SYS,TOL,ORD,ALPHA)  calculates for the 
%       transfer function
%                                       -1
...
%       on the ALPHA-stable part of SYS (see Method with 'type spa').
%
...
[ar,br,cr,dr,hsv]=sysred(4,a,b,c,d,tol,discr,ord,alpha);
