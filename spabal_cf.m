function [sysr,hsv] = spabal_cf(fact,sys,tol,ord,alpha)
%SPABAL_CF Singular perturbation approximation of coprime factors 
%          with balancing.
%          [SYSR,HSV] = SPABAL_CF(FACT,SYS,TOL,ORD,ALPHA)  calculates for 
...
%          Singular Perturbation Approximation method with balancing 
%          on a coprime factorization of G.
...
%
%          TOL is a tolerance vector [TOL1, TOL2, TOL3], where TOL1 
%          is the tolerance for model reduction, TOL2 is the tolerance
%          for computing a minimal realization of the extended system 
...
%          the extended system (see Method with 'type spabal_cf').
%
...
%          system (see Method with 'type spabal_cf'). Then
...
%
%          2. Perform the Singular Perturbation Approximation model 
%             reduction algorithm, with balancing, on the extended system
%                                           ( Q )
...
[ar,br,cr,dr,hsv]=sysred(10*k+3,a,b,c,d,tol,discr,ord,alpha);
