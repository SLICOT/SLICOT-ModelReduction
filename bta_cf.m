function [sysr,hsv] = bta_cf(fact,sys,tol,ord,alpha)
%BTA_CF Balance and truncate approximation of coprime factors 
%       without balancing.
%       [SYSR,HSV] = BTA_CF(FACT,SYS,TOL,ORD,ALPHA)  calculates for 
...
%       balancing-free Balance & Truncate approximation method 
...
%       the extended system (see Method with 'type bta_cf').
%
...
%       system (see Method with 'type bta_cf'). Then
...
%
%       2. Perform the balancing-free Balance and Truncate model reduction
%          algorithm on the extended system
%                                           ( Q )
...
[ar,br,cr,dr,hsv]=sysred(10*k+2,a,b,c,d,tol,discr,ord,alpha);
